...
const Breadcrumb = ({ className, icon, children }) => {
  ...
  return (React.createElement(List, {type: "horizontal", className: classNames(className.root)}, 
    Children.map(children, (child, i) => {
      return (
        React.createElement(ListItem, {key: i, className: classNames(className.list)}, 
          child, 
          i !== children.length - 1 &&
